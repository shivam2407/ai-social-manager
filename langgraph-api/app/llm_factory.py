...
_MOCK_RESPONSES: dict[str, str] = {
    "trend_researcher": json.dumps({
        ...
        "competitor_insights": [
            {"competitor_name": "@garyvee", "platform": "twitter", "post_summary": "Thread on why small businesses should stop chasing perfection and start shipping — 'Your first 100 customers don't care about your logo'", "content_theme": "Anti-perfectionism", "why_it_works": "Contrarian hook grabs attention, thread format rewards engagement with algorithmic boost", "engagement_notes": "High retweet ratio from the opening line alone", "opportunity": "Pair the hot take with a real behind-the-scenes story from our own journey"},
            {"competitor_name": "@hubspot", "platform": "linkedin", "post_summary": "Founder story about failing 3 times before finding product-market fit, with specific revenue numbers at each stage", "content_theme": "Founder vulnerability with data", "why_it_works": "Personal narrative + professional insight format, strong hook before the fold, specific numbers add credibility", "engagement_notes": "High comment engagement — people sharing their own failure stories", "opportunity": "Add raw, unpolished moments instead of corporate storytelling — show the messy kitchen, not just the finished product"},
            {"competitor_name": "@thebakefeed", "platform": "instagram", "post_summary": "Carousel showing 'What I posted vs what it actually looked like' — polished bread photo next to the ugly first attempt", "content_theme": "Relatable imperfection", "why_it_works": "Before/after format drives saves, self-deprecating humor makes the brand approachable", "engagement_notes": "High save rate on carousels, lots of 'same!' comments", "opportunity": "Do this with our actual product journey — real photos, not staged"},
        ],
    }),
